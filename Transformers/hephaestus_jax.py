...
class TabTransformer(nn.Module):
    ...
    def __call__(
        ...
        # print(
        #     f"inf_mask: {inf_mask[:, :, None].shape}",
        #     f"numeric_col_embeddings: {numeric_col_embeddings.shape}",
        #     f"numeric_inputs: {numeric_inputs.shape}",
        #     f"base_numeric: {base_numeric.shape}",
        # )
        ...
        # print(f"num_embeddings: {num_embeddings.shape}")
        # num_embeddings = (
