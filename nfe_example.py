    ...
    df = pd.DataFrame(
        {
            ...
            "maintenance_status": [
                maintenance_statuses[maintenance_status[i]] for i in range(n_samples)
            ],
            "nox": nox.numpy(),
        }
    )
...
def train_and_compare_models():
    """Train and compare Standard and Neural Feature Engineering models."""
    print("🚀 Neural Feature Engineering vs Standard Model Comparison")
    print("=" * 60)
    ...
    configs = {
        "Standard": sr.SingleRowConfig.generate(
            train_df, target="nox", use_moe=False, use_neural_feature_engineering=False
        ),
    ...
    for model_name, config in configs.items():
        ...
        with torch.no_grad():
            ...
            if hasattr(model, "get_neural_feature_engineering_metrics"):
                ...
                if nfe_metrics:
                    print("  🧠 Neural Feature Engineering:")
                    ...
                    if "enabled_components" in nfe_metrics:
                        ...
                        print(f"    Enabled components: {enabled_list}")
    ...
    print("   with minimal parameter overhead!")
    print("\n💡 Key advantages:")
    print("   • Learns meaningful feature interactions automatically")
    print("   • Only 10% parameter increase vs standard model")
    print("   • Includes polynomial, ratio, and attention-based features")
    print("   • Provides interpretable feature importance metrics")
